...
const AboutPage = () => {
  return (
    <div className="container mx-auto mb-24">
      <h2 className="mb-8 mt-24 text-3xl font-bold text-primary sm:text-4xl md:text-[40px]">
      ...
      <div className="flex text-primary justify-between">
        <div className="w-2/3">
          <p className="mb-4">
            ...
            race? I know the feeling all too well. I&apos;m a Millennial
            who&apos;s been there, done that. But guess what? I&apos;ve cracked
            the code to break free, and now I&apos;m here to share my journey
            and the secrets I&apos;ve learned along the way.
          </p>
